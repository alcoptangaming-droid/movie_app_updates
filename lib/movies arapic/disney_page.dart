...
class DisneyPage extends StatefulWidget {
  ...
  @override
  _DisneyPageState createState() => _DisneyPageState();
}
...
class _DisneyPageState extends State<DisneyPage> {
  ...
  Future<void> loadMovies({bool showMessages = true}) async {
    ...
    try {
      // ✅ استخدام أفلام الأنمي/ديزني
      final loadedMovies = await ApiService.getDisneyMovies();
      ...
      if (mounted) {
        ...
        if (showMessages) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('تم تحديث قائمة أفلام الأنمي/ديزني!'),
      ...
      print('[DisneyPage] Error loading movies: $e');
      if (mounted) {
  ...
  AppBar _buildMainAppBar() {
    return AppBar(
      ...
      title: _showSearchBar
          ? _buildSearchField()
          : const Text('أفلام أنمي وديزني', // ✅ تغيير العنوان
              style: TextStyle(
                color: Colors.white,
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: const InputDecoration(
          hintText: 'ابحث في أفلام الأنمي والديزني...', // ✅ تغيير النص
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('جاري تحميل أفلام الأنمي والديزني...', // ✅ تغيير النص
            ...
            child: ConstrainedBox(
              ...
              child: Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    const Icon(Icons.animation_outlined, // ✅ تغيير الأيقونة
                        size: 64, color: Colors.grey),
                    const SizedBox(height: 16),
                    const Text('لا توجد أفلام أنمي أو ديزني متاحة حالياً', // ✅ تغيير النص
                        style: TextStyle(fontSize: 18, color: Colors.grey)),
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.purple.withOpacity(0.8), // ✅ لون مميز للأنمي
                          borderRadius: BorderRadius.circular(4),
                        ),
                        child: Text(
                          movie.category?.toLowerCase().contains('anime') == true 
                              ? 'أنمي' 
                              : 'ديزني',
                          style: const TextStyle(
                            color: Colors.white,
